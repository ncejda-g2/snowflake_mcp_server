...
async def get_table_schema(
    ...
    try:
        ...
        if not table_info:
            ...
            logger.info(
                f"Table {database}.{schema}.{table} not in cache, querying directly"
            )
...
async def describe_table(
    connection: SnowflakeConnection, full_table_name: str, include_stats: bool = False
) -> dict[str, Any]:
    """
